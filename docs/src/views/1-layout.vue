<template>
  <div>
    <h3>表单布局</h3>
    <v-form label-width="120px" :cols="[{ label: 'aaa',span: 8 },{ label: 'bbb', span: 16 }]" :item-gutter="10">
      <v-form-line :cols="[{ label: '2列并排布局' },{ label: '2列并排布局' }]">
        <input>
        <input>
      </v-form-line>
      <v-form-line :cols="[{label: '3列并排布局' },{ label: '3列并排布局' },{ label: '3列并排布局' }]">
        <input>
        <input>
        <input>
      </v-form-line>
      ...
      <v-form-line label="2列并列布局">
        <input>
        <input>
      </v-form-line>
      <v-form-line label="多段并列布局" :span="12">
        <input>
        <input>
        <input>
      </v-form-line>
